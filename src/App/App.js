                ...
                <section>
                    <div className="pb-5 pt-4" style={{ backgroundColor: '#C28A81', color: '#fff' }}>
                        <div className="container">
                            ...
                            <p>Фалшивите новини могат да бъдат опасни. Те оформят поведението ни чрез внушения и противопоставяне; влияят на изхода на избори, а оттам – на законите и средата, в която живеем; и дори могат да поставят в риск здравето ни.</p>
                            <p>Фалшивите новини оставят лош вкус.</p>
                        </div>
                    </div>
